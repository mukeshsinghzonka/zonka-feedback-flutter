...
class ApplyTemplateManagerController extends BaseControllerWithParams<void,ParamsValue> {
  ...
  Future<void> call(ParamsValue  params) async {
    ...
    ApiResult<void> response = await getIt.get<ApplyTemplateUc>().call(ApplyTemplateParams(workspaceController.selectedWorkspace!.workSpaceId, params.surveyId,params.templateId ));
