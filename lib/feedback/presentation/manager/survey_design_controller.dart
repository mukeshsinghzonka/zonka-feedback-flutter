...
class SurveyDesignFieldController extends GetxController {
  ...
  Rx<SuveryScreenBottom> screenBotton =
      SuveryScreenBottom.templateBottomBar.obs;

  late Rx<DateTime> _surveyStartDateTime = DateTime.now().obs;
  ...
  late Rx<DateTime> _surveySubmitDateTime = DateTime.now().obs;
  ...
  final  Rx<DateTime> _surveyFillDateTime = DateTime.now().obs;
  ...
  void setFieldFromSurveyModel() {
    ...
    surveyBgImage.value =
        '${valueData.s3GalleryImageUrl}${valueData.surveyBgGalleryImageId?.companyId}/${valueData.surveyBgGalleryImageId?.path}';
    surveyBgImageLogo.value =
        '${valueData.s3GalleryImageUrl}${valueData.logoGalleryImageId?.companyId}/${valueData.logoGalleryImageId?.path}';
    s3GalleryImageUrl.value = valueData.s3GalleryImageUrl;
    introBgImageUrl.value = createImageUrl(
        valueData.introPage?.backgroundGalleryImageId?.compnayId ?? "",
        valueData.introPage?.backgroundGalleryImageId?.path ?? "");
    introLogoImageUrlLogo.value = createImageUrl(
        valueData.introPage?.pageLogoGalleryImageId?.compnayId ?? "",
        valueData.introPage?.pageLogoGalleryImageId?.path ?? "");
    thankyouPageUrlBg.value = createImageUrl(
        valueData.thankyouPage?.backgroundGalleryImageId?.compnayId ?? "",
        valueData.thankyouPage?.backgroundGalleryImageId?.path ?? "");
    ...
    languageBackgroundPage.value = createImageUrl(
        valueData.languagePage?.backgroundGalleryImageId?.compnayId ?? "",
        valueData.languagePage?.backgroundGalleryImageId?.path ?? "");
    ...
    showSkipButtonInsteadOfNext.value =
        valueData.showSkipButtonInsteadOfNext ?? false;
    hideDoneButtonInClickThrough.value =
        valueData.hideDoneButtonInClickThrough ?? false;
    switchLanguageScreenDisplay.value =
        valueData.switchLanguageButtonDisplay ?? "";
    switchLanguageButtonDisplay.value =
        valueData.switchLanguageScreenDisplay ?? "";
